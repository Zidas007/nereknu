...
def sensor():
    ...
    i = Data(cas=cas, hodnota=data["data"]["CPU"], typ=data["data"]["nadpis"])
    db.session.add(i)
    i = Data(cas=cas, hodnota=data["data"]["DISKUSAGE"], typ="DISKUSAGE")
    db.session.add(i)
    i = Data(cas=cas, hodnota=data["data"]["NETIOIN"], typ="NETIN")
    db.session.add(i)
    i = Data(cas=cas, hodnota=data["data"]["NETIOOUT"], typ="NETOUT")
    db.session.add(i)
    db.session.commit()
    print "Ulozeno"
