...
Revision ID: 3af9543c8b79
Revises: None
Create Date: 2019-04-17 11:19:30.033446

"""

# revision identifiers, used by Alembic.
revision = '3af9543c8b79'
down_revision = None
...
def upgrade():
    ...
    sa.Column('hodnota', sa.Float(), nullable=True),
    sa.Column('disk', sa.Integer(), nullable=True),
    sa.PrimaryKeyConstraint('id', name='pk_data'),
    sqlite_autoincrement=True
    )
    op.create_index('ix_data_cas', 'data', ['cas'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ix_data_cas', table_name='data')
    op.drop_table('data')
